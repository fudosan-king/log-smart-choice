...
<head>
    <script rel="preload" as="script" async defer src="//statics.a8.net/a8sales/a8sales.js"></script>
    <script rel="preload" as="script" async defer src="https://r.moshimo.com/af/r/maftag.js"></script>
    <script rel="preload" as="script" async defer src="/js/argsv.min.js"></script>
    <script rel="preload" as="script" async defer type="text/javascript" src="//aff.i-mobile.co.jp/script/lpcvlink.js"></script>
    ...
    <link rel="preload" onload="this.rel='stylesheet'" as="style" href="https://fonts.googleapis.com/css2?family=Roboto:wght@500&display=swap">
