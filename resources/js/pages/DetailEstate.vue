<template>
    <!-- <main> -->
    <div class="box_template padding-boxtemplate">
                    ...
                    <span class="price">
                        ...
                        <template v-else>
                            ...
                            <template v-if="estate.renovation_type != 'リノベ済物件'"
                                ><span class="renovate_title">（改装前価格）</span></template
                            >
                        </template>
                    </span>
                </div>
                            ...
                            <p class="subtitle mb-2">
                                <small v-if="estate.estate_information"
                                    ...
                                    <template v-if="estate.address"
                                        ...
                                        }}{{ estate.address.tyoume }}{{ estate.address.gaikutiban }}<br />
                    ...
                    <section class="p-0">
                        <div class="box_top mb-0 title_estate_renovation">
                            <p class="subtitle mb-2">
                                <template v-if="estate.estate_information">
                                    <template
                                        v-if="estate.estate_information.renovation_media[0]"
                        ...
                        <div class="box_renovation_specifications">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-lg-6">
                                            ...
                                            <div class="box_simulation_result">
                                                <p class="text-center d-block d-lg-none btn_simulation_result mb-3">
                                                    毎月のお支払例
                                                </p>
                                                ...
                                                <p class="text-center mt-3">
                                                    <b
                                                        >管理費：{{
                                                            $lscFormatCurrency(estate.management_fee)
                                                        }}円／修繕積立金：{{
                                            ...
                                            <p class="text-center box_showmore">
                                                <a
                                                    @click="mobileHandleShow"
                                                    class="btn btnshowhide d-block d-lg-none"
                                                    :class="{ show: mobileShow }"
                                                ></a>
                                            </p>
                                                        ...
                                                        <div class="col-6 col-lg-6">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <input
                                                                    ...
                                                                    v-on:change="
                                                                        changeMoney('lscBorrowedMoney', $event)
                                                                    "
                                                        ...
                                                        <div class="col-6 col-lg-6">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <input
                                                                    ...
                                                                    max="3"
                                                                    v-on:blur="
                                                                        changeMoney('lscPaymentInterest', $event)
                                                                    "
                            ...
                            <div class="renovation_specifications_table">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <template v-if="estate.address">
                                                ...
                                                {{ estate.address.pref }}{{ estate.address.city
                                                }}{{ estate.address.ooaza }}{{ estate.address.tyoume
                                                }}{{ estate.address.gaikutiban }}
                                            </template>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <template
                                        v-if="estate.renovation_type != 'リノベ済物件' && estate.status != '成約済'"
                                    >
                                        <tr>
                                            <th>リノベーション費用</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li>
                                                                        ...
                                                                        {{
                                                                            ...
                                                                            estate.usen_fee.repeat_cost.per == 'm'
                                                                                ? '月'
                                                                                : '年'
                                                                        }}
                                                                    </li>
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li>
                                                                        ...
                                                                        {{
                                                                            ...
                                                                            estate.catv_fee.repeat_cost.per == 'm'
                                                                                ? '月'
                                                                                : '年'
                                                                        }}
                                                                    </li>
                                            ...
                                            <template v-if="estate.spa_fee && estate.spa_fee.price">
                                                <div>
                                                    温泉使用料：{{
                                                        $lscFormatCurrency(estate.spa_fee.price)
                                                    }}円/<template v-if="estate.spa_fee.per == 'm'">月</template
                                        ...
                                        <td>
                                            <template v-if="estate.delivery">
                                                ...
                                                <template v-else-if="estate.delivery.delivery_date_type == '指定有り'"
                                                    ...
                                                    {{
                                                        dayjs(
                                                            parseInt(estate.delivery.delivery_date.$date.$numberLong)
                                                        ).format('YYYY年MM月')
                                                    }}{{ estate.delivery.delivery_date_about }}</template
                                                >
                                                <template v-else
                                                    >契約後 {{ estate.delivery.resident_span }} ヶ月</template
                                                >
                                            </template>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{
                                                estate.built_date
                                                    ? dayjs(parseInt(estate.built_date.$date.$numberLong)).format(
                                                          'YYYY年MM月'
                                                      )
                                                    : ''
                                            }}
                                        ...
                                        <td>
                                            ...
                                            <template v-else-if="estate.land_rights == '借地権のみ'">
                                                ...
                                                <template v-if="estate.land_leashold_type == '新規'">
                                                    ({{ estate.land_leashold_years }}年
                                                    {{ estate.land_leashold_months }}月)
                                                </template>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-12">
                        ...
                        <p class="text-center mt-3">
                            <a class="btn btn-load-more" href="/list">もっと見る</a>
                        </p>
                    </div>
                </div>
            </div>
