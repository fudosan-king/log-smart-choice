 ...
 */
class PagesSeoController extends VoyagerBaseController
{
            ...
            if ($search->value != '' && $search->key && $search->filter) {
                ...
                switch ($search->key) {
                    case 'name':
                        ...
                        break;
                    case 'status':
                        if ($search_value == 'Activate' || $search_value == '%Activate%') {
                            $search_value = TabSearch::ACTIVE;
                        }

                        if ($search_value == 'Deactivate' || $search_value == '%Deactivate%') {
                            $search_value = TabSearch::INACTIVE;
                        }
                    default:
